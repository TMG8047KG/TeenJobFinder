<x-layout>
    ...
    <div class="h-screen bg-white dark:bg-gray-900 inset-0 w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#3a3b3d_1px,transparent_1px)] [background-size:16px_16px]">
        <div class="min-h-screen flex items-center justify-center w-full">
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg px-8 py-6 max-w-md border border-gray-100 dark:border-gray-950">
                <div class="h-full flex justify-center items-center text-center">
                    <div class="px-2 font-semibold">
                        <a class="text-3xl mb-4 block dark:text-gray-300">Create a post</a>
                        <div class="flex space-x-4">
                            <x-post.option option="company" class="btn btn-job-offer">
                                <span class="flex items-center justify-center text-gray-600 dark:text-gray-300 shadow-md px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-900">
