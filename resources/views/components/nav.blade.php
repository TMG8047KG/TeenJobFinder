                ...
                <div class="md:hidden w-full" id="navbar-solid-bg">
                    <ul class="flex flex-row justify-center font-medium space-x-6 md:space-x-8">
                        ...
                        <x-nav-link route="jobs">
                            <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none">
                                <g fill="currentColor">
                                    <path d="M12 3V4M12 9V12M12 17V21M4 4H19L21 6.5L19 9H4V4ZM20 12H5L3 14.5L5 17H20V12Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg>
                        </x-nav-link>
                        <x-nav-link route="home">
                        ...
                        <x-nav-link route="profile">
                           <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none">
                                <g fill="currentColor">
                                    <path id="vector" d="M12 11C14.4853 11 16.5 8.98528 16.5 6.5C16.5 4.01472 14.4853 2 12 2C9.51472 2 7.5 4.01472 7.5 6.5C7.5 8.98528 9.51472 11 12 11Z" stroke="#000000" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path id="rec" d="M5 18.5714C5 16.0467 7.0467 14 9.57143 14H14.4286C16.9533 14 19 16.0467 19 18.5714C19 20.465 17.465 22 15.5714 22H8.42857C6.53502 22 5 20.465 5 18.5714Z" stroke="#000000" stroke-width="2.2"/>
                                </g>
                            </svg>
                        </x-nav-link>
                    </ul>
