...
<div class="min-w-[200px] bg-white dark:bg-gray-800 shadow-md rounded-xl p-4">
    <a href="{{ route('post.show', $id) }}">
        <div class=" relative flex justify-between overflow-hidden cursor-pointer w-full object-cover object-center rounded-lg shadow-md h-64" style="background-color: slategrey ">
            <div class="bg-violet-600 dark:bg-violet-800 relative flex flex-row items-start h-full w-full ">
                <div class="p-5 rounded-lg w-full z-10">
                    <h4 class="mt-1 text-violet-900 dark:text-gray-900 text-xl font-semibold">{{ $title }}</h4>
                    <div class="mb-4">
