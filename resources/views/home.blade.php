<x-layout>
    ...
    <div class="px-3 rounded-lg  flex flex-col w-full">
        <h4 class="text-black text-xl font-semibold  leading-tight truncate">Find your job
        </h4>
    </div>
    ...
    <div class=" p-3 space-y-4 z-0">
        ...
        <div class="grid m-0  grid-cols-2  space-x-4 overflow-y-scroll flex justify-center items-center w-full ">
            <div class="relative flex flex-col justify-between overflow-hidden cursor-pointer w-full object-cover object-center rounded-lg shadow-md h-64 my-2" style="background-color: slategrey ">
                <div class="relative flex flex-row items-end  h-72 w-full ">
                    <div class="absolute right-0 top-0 m-2">
                    </div>
                    <div class="p-5 rounded-lg  flex flex-col w-full z-10 ">
                        <h4 class="mt-1 text-white text-xl font-semibold  leading-tight truncate">Job Example 1
                        </h4>
            ...
            <div class="relative flex flex-col justify-between overflow-hidden cursor-pointer w-full object-cover object-center rounded-lg shadow-md h-64 my-2" style="background-color: slategrey ">
                <div class="relative flex flex-row items-end  h-72 w-full ">
                    ...
                    <div class="p-5 rounded-lg  flex flex-col w-full z-10 ">
                        <h4 class="mt-1 text-white text-xl font-semibold  leading-tight truncate">Job Example 2
                        </h4>
                        </div>
                    </div>
                </div>
